...
3. Confirm server starts through terminal

   ```
   nodemon app.js
   ```

4. Should see "listening on port 8080" message in terminal

5. Open seperate Terminal tab and enter 

   ```
   http GET localhost:8080/guests
   ```

6. Should see list of guests
